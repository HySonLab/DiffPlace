...
class GAE(nn.Module):
    def __init__(self, input_dim, hidden1_dim, hidden2_dim, dropout):
        super(GAE, self).__init__()
    ...
    def encode(self, X, adj):
        hidden = F.dropout(self.base_gcn(X, adj), self.dropout, training=self.training)
...
class VGAE(GAE):
    def __init__(self, input_dim, hidden1_dim, hidden2_dim, dropout):
        super(VGAE, self).__init__(input_dim, hidden1_dim, hidden2_dim, dropout)

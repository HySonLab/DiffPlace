...
def load_graph_data(dataset_name, augment = False, train_data_limit = None, val_data_limit = None):
    ...
    dataset_path = os.path.join(os.path.dirname(__file__), f'data/graph/{dataset_name}')
...
def load_synthetic_graph_data(dataset_name, train_data_limit = None, val_data_limit = None):
    dataset_path = os.path.join(os.path.dirname(__file__), '<YOUR_DATA_PATH>', dataset_name  # Replace with your data path)
